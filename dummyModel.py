...
# Step 1: Load the Training Document (plain text)
def load_training_doc(file_path):
...
if __name__ == "__main__":
    ...
    training_doc_path = "/Users/hnguyen/Downloads/houseHistory.txt"  # Path to your plain text file
    base_model_name = "gpt2"  # Base model name, e.g., "gpt2" or "distilgpt2"
    question_to_ask = "What is house music?"

    # Step 1: Load training document
    training_text = load_training_doc(training_doc_path)
